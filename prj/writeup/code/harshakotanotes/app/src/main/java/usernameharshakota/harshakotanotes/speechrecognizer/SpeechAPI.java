package usernameharshakota.harshakotanotes.speechrecognizer;
...
/*
This is code provided by the Google from their Github account that performs actions when speech
starts, and on recognised, and on end.
 */
public class SpeechAPI {
    ...
    public boolean isEmptyListener() { return mListeners.isEmpty(); }
